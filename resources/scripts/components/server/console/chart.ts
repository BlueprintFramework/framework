    ...
    scales: {
        ...
        y: {
            ...
            ticks: {
                display: true,
                count: 3,
                color: getComputedStyle(document.body).getPropertyValue('--chart-ticks'),
                font: {
                ...
                next(
                    {
                        ...
                        borderColor: getComputedStyle(document.body).getPropertyValue('--chart-graph-border'),
                        backgroundColor: getComputedStyle(document.body).getPropertyValue('--chart-graph-bg'),
                    },
                    index
                )
            ),
